...
<nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">HRP Interaktív Program</a>
        </div>
    ...
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
                ...
                <li class="<?php if ($active == 'company_add') echo 'active'; ?>"><a href="company_add.php">Cég hozzáadása</a></li>
                <li class="<?php if ($active == 'cards_overview') echo 'active'; ?>"><a href="cards_overview.php">Kártyák kezelése</a></li>
